...
class AfricanFinancialsAdapter(BaseSourceAdapter):
    """Universal AfricanFinancials Aggregator Adapter covering 16 African equity markets."""
    ...
    def get_candidate_urls(self, issuer: Issuer) -> List[str]:
        ...
        # Common URL variations on AfricanFinancials
        return [
        ...
        for url in urls_to_try:
            try:
                ...
                if r.status_code != 200:
                    continue
                extracted = self.extract_candidates_from_html(r.text, url, issuer, start_year, end_year)
                for c in extracted:
